...
namespace Garnet.server
{
    class GarnetServerQuic : GarnetServerBase, IServerHook
    {
        ...
        public GarnetServerQuic(string address, int port, int networkBufferSize = default, IGarnetTlsOptions tlsOptions = null, int networkSendThrottleMax = 8, ILogger logger = null)
